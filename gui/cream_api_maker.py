...
class CreamAPI(QtCore.QThread):
    ...
    def run(self):
        ...
        # with open(os.path.join(self.parent_directory, 'creamapi_steam_files', 'cream_api.ini'), 'w',
        #           encoding='utf-8') as f:
    ...
    #     with open(os.path.join(self.parent_directory, 'creamapi_launcher_files', 'cream_api.ini'), 'w',
    #               encoding='utf-8') as f:
    #         current_datetime = datetime.now().strftime("%d.%m.%Y")
    #         f.write(f"; created {current_datetime}\n")
    #         f.write("[steam]\n")
