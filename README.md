...
- Если после анлока и попытки запуска игры лаунчер выдает ошибку запуска и просит проверить целостность файлов, сделайте это, анлокер еще раз открывать не нужно. *Я е уверен, что это последствия работы самого анлокера, но такое заметил после обновления игры на 3.11.1*
